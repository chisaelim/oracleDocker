...
CREATE TABLE Client_Type (
    CLIENT_TYPE NUMBER(3,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Clients (
    CLIENT_NO NUMBER(8,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Product_Type (
    PRODUCTTYPE_ID NUMBER(3,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE JOBS (
    JOB_ID NUMBER(3,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Employees (
    EMPLOYEEID NUMBER(6,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE INVOICES (
    INVOICENO NUMBER(12,0) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
